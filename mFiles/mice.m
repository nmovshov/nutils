...
hold on
m1=plot(mouse(1).position(1),mouse(1).position(2),'xb', 'linew', 2);
m2=plot(mouse(2).position(1),mouse(2).position(2),'xr', 'linew', 2);
m3=plot(mouse(3).position(1),mouse(3).position(2),'xg', 'linew', 2);
m4=plot(mouse(4).position(1),mouse(4).position(2),'xy', 'linew', 2);
m=[m1 m2 m3 m4];
